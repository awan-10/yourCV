...
:showtitle!:
:address: Richardson • TX 75082 • USA
...
My broad interests lie at the intersection of novel system optimization techniques explored by High Performance Computing (HPC) researchers and emerging strategies to train and serve large-scale Artificial Intelligence (AI) models including Large Language Models (LLMs) at scale.

* *DeepSpeed (http://www.deepspeed.ai) at Microsoft*

** Principal Research Manager (Nov '23 - Present)

*** Leading a diverse team of researchers and software engineers. We work together to investigate novel techniques for efficient inference of AI models including LLMs on GPUs and CPUs.
*** Latest public blog: https://github.com/microsoft/DeepSpeed/tree/master/blogs/deepspeed-fastgen
 
** Senior Researcher (Jun '20 — Oct '23)

*** Investigate communication and computation challenges in the context of Machine/
Deep Learning (ML/DL) at scale.

*** Contribute to design and implementation of various aspects of DeepSpeed; an open-source and scalable optimization library for training and inference of diverse AI models including LLMs. 

*** Lead investigator and maintainer of Mixture of Experts (MoE) model support in DeepSpeed.
...
*** Utilize existing benchmark suites like OSU Micro-benchmarks (OMB), Intel MPI benchmarks (IMB) and test suites like MPICH tests, Intel tests, etc. to rigorously test and evaluate new designs on multiple HPC systems with diverse set of CPU and GPU architectures.
...
* Mentored undergraduate and graduate students at The Ohio State University to work on various research and development projects.
...
* Proven people management and project management experience (Gained as part of leading the DeepSpeed team in the tech. lead role and now as a People Manager at Microsoft). 
* Strong programming skills in Python, C, Java, and Java for HPC.
...
** Delivered several elaborate presentations on technical projects like DeepSpeed, FastGen, OSU-Caffe, High-Performance Deep Learning (HiDL), MVAPICH2, Constella, Gadget-2, Oil Reservoir Simulators, and MPJ-IO.

== References

. Yuxiong He
 
 Former DeepSpeed lead at Microsoft.
 LinkedIn: https://www.linkedin.com/in/yuxiong-he-75432112/
